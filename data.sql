...
('NS Pokemon《寶可夢 朱/紫》 (朱)','340','RPG','game9.jpeg','SWITCH','
在《寶可夢 朱／紫》中，玩家將能在豐富呈現的開放世界中自由地冒險。
無縫綿延的遼闊大自然、城鎮街景，以及栩栩如生地生活在其中的寶可夢們。
不論是在天空、海洋、森林，還是在城鎮，在這個世界的每個角落都有可能見到寶可夢們的身影。
《寶可夢》系列不可或缺的寶可夢對戰、捕捉寶可夢等精華樂趣在本作中絲毫不減，
是從小朋友到大人都能夠歡樂遊玩的開放世界作品。','true')
...
-- INSERT INTO users (username,password,email,icon,address,phone_number,is_admin) VALUES ('admin111','881229','123@gmail.com','621c65b983f19.jpeg','hk','123456','true'),('chung22','881229','1133@gmail.com','621c65b983f19.jpeg','hk','123456','false');
